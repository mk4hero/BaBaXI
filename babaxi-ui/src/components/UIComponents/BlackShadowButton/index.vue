<template>
    <div class="BlackShadowButton" id="BlackShadowButton"> 
        <label class="switch">
            ...
            <svg class="switch__base-neon" viewBox="0 0 40 24" width="40px" height="24px">
                <defs>
                    <filter id="switch-glow">
                        <feGaussianBlur result="coloredBlur" stddeviation="50"></feGaussianBlur>
                        <feMerge>
			...
			<!-- 可动旋钮knob的阴影，实现按钮立体化效果 -->
            <span class="switch__knob-shadow"></span>
			<!-- 可动旋钮knob容器，就相当于一层包装纸 -->
